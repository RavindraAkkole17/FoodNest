...
<nav class="navbar">
    ...
    <div class="nav-right">
        ...
        %>
            <span class="user-greeting" style="align-self: center; margin-right: 15px; font-weight: 600; color: #ff6b35;">
                Hello, <%= loggedInUser.getUserName() %>
            </span>
            <a href="orderHistory" style="align-self: center; margin-right: 15px; text-decoration: none; color: white; font-weight: 500;"><i class="fas fa-history"></i> History</a>
            <a href="logout"><button class="btn login-btn" style="background: #dc3545; margin-right: 10px;">Logout</button></a>
        <%
        }
        %>
...
<section class="hero">
    ...
    <%
        ...
        <p>
            ...
            Fresh food, lightning-fast delivery, amazing offers,
            and delicious meals delivered right to your doorstep.
        </p>

        <a href ="#resto"><button class="order-btn" >
            Order Now
        </button></a>
...
<div class="restaurant-container">
    ...
    <div class="card-body">
        ...
        <div class="info">
            <strong>Cuisine:</strong> <%= restaurant.getCuisineType() %>
        </div>

        <div class="info">
            <strong>Address:</strong> <%= restaurant.getAddress() %>
        </div>

        <div class="info">
            <strong>Delivery Time:</strong> <%=restaurant.getDeliveryTime() %> Minutes
        </div>

        <span class="status active">
            <a href="menu?restaurantId=<%= restaurant.getRestaurantId()%>">Open Now</a>
        </span>
...
<footer>
    © 2026 FoodNest | Delivering Happiness One Meal At A Time 🍽️
</footer>
